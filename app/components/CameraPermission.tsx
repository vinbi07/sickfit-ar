  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center bg-black bg-opacity-50">
      <div className="mx-4 rounded-lg bg-white p-6 shadow-lg max-w-sm">
        <h2 className="text-xl font-bold text-gray-900">Camera Access Required</h2>
        
        <p className="mt-4 text-gray-600">
          To use the AR try-on feature, we need access to your camera to show you how the socks
          look on your feet.
        </p>
